...
// MeetingRequestsPage is the page where you can see the meeting applications you received 
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text('Meeting requests', style: TextStyle(color: kTextColor, fontWeight: FontWeight.normal)),
          backgroundColor: Colors.white,
