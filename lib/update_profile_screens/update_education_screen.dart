      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: Text('Add your former education, courses, etc.', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold))),
          ...
          DropdownSearch<String>(
            ...
            items: ["Bachelor", "Master", "Course", 'PHD', 'Online Degree', 'Other'],
            label: "Select type of degree",
            hint: "country in menu mode",
            onChanged: print,
            selectedItem: "Bachelor"),
          ...
          Card(
            ...
            child: TextFormField(
              decoration: InputDecoration(
                labelText: 'Enter the name of your degree'
              ),
            ),
          ),
          ...
          Card(
            ...
            child: TextFormField(
              decoration: InputDecoration(
                labelText: 'Enter the name of the university'
              ),
            ),
          ),
